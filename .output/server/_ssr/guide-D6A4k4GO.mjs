...
import { $ as BookOpen, A as Grid3x3, E as Keyboard, P as Film, Q as Brush, T as Layers, V as Command, d as Search, et as ArrowLeft, f as Save, t as Zap, u as Sparkles, w as Maximize, y as Palette, z as Download } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/guide-D6A4k4GO.js
...
var copy = {
	vi: {
		...
		intro: "Tài liệu chi tiết cho từng công cụ, từng chức năng và các quy trình làm pixel art trong Pixora Studio.",
		back: "Về Studio",
		...
		tipsLabel: "Mẹo / lưu ý",
		defaultTip: "Nếu thao tác không đúng như mong đợi, hãy kiểm tra layer đang chọn, mask Magic Wand, tag animation đang bật và trạng thái autosave.",
		sections: [
			{
				id: "quickstart",
				title: "Bắt Đầu Nhanh",
				...
				icon: Zap,
				color: "#facc15",
				summary: "Các bước cơ bản để mở Studio, chọn màu, vẽ pixel, hoàn tác và lưu project an toàn.",
				items: [
					{
						title: "Mở Studio",
					...
					},
					{
						...
						tips: ["Autosave chỉ là bản nháp trong trình duyệt. Save Project mới là bản sao lưu nên giữ."]
					}
				]
			},
			{
				...
				icon: Maximize,
				color: "#38bdf8",
				summary: "Giải thích header, toolbar, canvas, panel bên phải, timeline và status bar để người mới không bị lạc.",
				items: [
					{
						title: "Header trên cùng",
						purpose: "Khu vực chứa File, Export, View, Undo, Redo, Command Palette và trạng thái project.",
						steps: [
					...
					},
					{
						...
						purpose: "Khu vực điều khiển canvas, preview, brush, selection, reference, palette và layers.",
						steps: [
			...
			},
			{
				...
				icon: Brush,
				color: "#a855f7",
				summary: "Tất cả công cụ trên toolbar bên trái, gồm công dụng, phím tắt, thao tác và mẹo làm việc.",
				items: [
					{
						title: "Brush",
						shortcut: "B",
					...
					},
					{
						...
						tips: ["Nếu thấy layer bên dưới hiện ra, nghĩa là pixel ở layer hiện tại đã trở thành transparent."]
					},
					{
						title: "Fill",
						shortcut: "F",
						...
						tips: ["Nếu fill không lan hết, vùng đó có thể bị chặn bởi pixel màu khác hoặc đang nằm ở layer khác."]
					},
					{
						title: "Color Picker",
						shortcut: "I",
						...
						tips: ["Picker lấy màu từ hình đã composite, nên có thể lấy kết quả sau opacity hoặc blend mode."]
					},
					{
						title: "Line",
						shortcut: "L",
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						steps: ["Giữ Space rồi kéo canvas, hoặc dùng chuột giữa nếu có.", "Pan chỉ di chuyển góc nhìn, không thay đổi pixel."]
					},
					{
						title: "Grid",
						shortcut: "G",
			...
			},
			{
				...
				icon: Layers,
				color: "#22c55e",
				summary: "Layers giúp tách line, màu, bóng, highlight và background để sửa mà không phá hỏng art.",
				items: [
					{
			...
			},
			{
				...
				icon: Film,
				color: "#f59e0b",
				summary: "Tạo animation bằng timeline, frame duration, onion skin và tag để export từng đoạn.",
				items: [
					{
			...
			},
			{
				...
				icon: Download,
				color: "#3b82f6",
				summary: "Xuất tác phẩm ra ảnh tĩnh, sprite sheet cho game, GIF để chia sẻ hoặc video WebM.",
				items: [
					{
						title: "Export Scale",
			...
			},
			{
				...
				icon: Sparkles,
				color: "#fb7185",
				summary: "Các quy trình mẫu để tạo sprite nhân vật, item, animation idle/run và tile seamless.",
				items: [
					{
	...
	en: {
		...
		intro: "A detailed manual for every tool, feature, export option, and pixel-art workflow inside Pixora Studio.",
		back: "Back to Studio",
		...
		defaultTip: "If something behaves differently than expected, check the active layer, Magic Wand mask, active animation tag, and autosave state.",
		sections: [
			{
				id: "quickstart",
				title: "Quick Start",
				...
				icon: Zap,
				color: "#facc15",
				summary: "The essential flow for opening Studio, choosing colors, drawing pixels, undoing edits, and saving safely.",
				items: [
					{
						title: "Open Studio",
			...
			},
			{
				...
				icon: Maximize,
				color: "#38bdf8",
				summary: "A map of the top bar, toolbar, canvas, right panels, timeline, and status readouts.",
				items: [
					{
						title: "Top bar",
					...
					{
						title: "Right panels",
						purpose: "Control canvas settings, preview, brush, selection, references, palette, and layers.",
						steps: [
			...
			},
			{
				...
				icon: Brush,
				color: "#a855f7",
				summary: "All toolbar tools with their purpose, shortcut, interaction model, and practical tips.",
				items: [
					{
						title: "Brush",
						shortcut: "B",
						...
						tips: ["Brush Size 1 gives the cleanest pixel-art line; larger sizes are useful for blocking areas."]
					},
					{
						title: "Dither",
						shortcut: "D",
					...
					},
					{
						...
						tips: ["If lower layers appear after erasing, the active layer's pixels are now transparent."]
					},
					{
						title: "Fill",
						shortcut: "F",
						...
						tips: ["If fill stops early, the region may be blocked by another color or drawn on another layer."]
					},
					{
						title: "Color Picker",
						shortcut: "I",
						...
						tips: ["Picker samples the composited canvas, so opacity and blend modes can affect the color."]
					},
					{
						title: "Line",
						shortcut: "L",
					...
					},
					{
						...
						tips: ["Use Magic Wand to recolor clothes, hair, or backgrounds without painting outside the region."]
					}
				]
			},
			{
				...
				items: [
					...
					},
					{
						...
						steps: ["Hold Space and drag the canvas, or use middle mouse if available.", "Panning only moves your view; it does not edit pixels."]
					},
					{
						title: "Grid",
						shortcut: "G",
			...
			},
			{
				...
				icon: Layers,
				color: "#22c55e",
				summary: "Layers let you separate line art, base color, shadows, highlights, and backgrounds.",
				items: [
					{
			...
			},
			{
				...
				icon: Palette,
				color: "#ec4899",
				summary: "Manage primary/secondary colors, presets, palette import/export, ramps, and generated harmonies.",
				items: [
					{
						title: "Primary / Secondary color",
			...
			},
			{
				...
				icon: Film,
				color: "#f59e0b",
				summary: "Create frame animation with timeline controls, frame duration, onion skinning, and tags.",
				items: [
					{
						title: "Frame timeline",
			...
			},
			{
				...
				icon: Sparkles,
				color: "#fb7185",
				summary: "Suggested workflows for character sprites, game items, idle animation, and seamless tiles.",
				items: [
					{
...
function GuidePage() {
	const [language, setLanguage] = (0, import_react.useState)("vi");
	const [activeId, setActiveId] = (0, import_react.useState)(copy.vi.sections[0].id);
	const [query, setQuery] = (0, import_react.useState)("");
	const current = copy[language];
	const activeSection = current.sections.find((section) => section.id === activeId) ?? current.sections[0];
	const visibleItems = (0, import_react.useMemo)(() => {
		const normalized = query.trim().toLowerCase();
		const entries = current.sections.flatMap((section) => section.items.map((item) => ({
			item,
			section
		})));
		if (!normalized) return activeSection.items.map((item) => ({
			item,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "min-h-screen bg-[#070816] text-slate-100",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "pointer-events-none fixed inset-0 overflow-hidden",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] bg-[size:40px_40px]" })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				className: "sticky top-0 z-30 border-b border-white/10 bg-[#080918]/85 backdrop-blur-xl",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { size: 17 })
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "rounded border border-fuchsia-300/30 bg-fuchsia-400/10 px-2 py-0.5 text-[10px] font-bold text-fuchsia-200",
										children: "v5.1"
									})
								]
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: ["vi", "en"].map((lang) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								onClick: () => setLanguage(lang),
								"aria-label": lang === "vi" ? "Tiếng Việt" : "English",
								title: lang === "vi" ? "Tiếng Việt" : "English",
								className: `grid h-8 w-9 place-items-center rounded text-lg leading-none transition ${language === lang ? "bg-fuchsia-500 shadow-[0_0_18px_rgba(217,70,239,0.35)]" : "opacity-55 hover:bg-white/10 hover:opacity-100"}`,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									"aria-hidden": "true",
									className: "flex items-center justify-center",
									children: lang === "vi" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VnFlag, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EnFlag, {})
								})
							}, lang))
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				className: "relative z-10 mx-auto grid max-w-7xl gap-5 px-4 py-5 lg:grid-cols-[300px_1fr]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", {
					className: "lg:sticky lg:top-[73px] lg:h-[calc(100vh-92px)]",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-lg border border-white/10 bg-white/[0.04] p-3 shadow-2xl",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mb-2 mt-4 px-2 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500",
								children: current.contents
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
								className: "max-h-[58vh] space-y-1 overflow-y-auto pr-1 lg:max-h-[calc(100vh-190px)]",
								children: current.sections.map((section) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									onClick: () => {
										setActiveId(section.id);
										setQuery("");
									},
									className: `flex w-full items-center gap-3 rounded-md border px-3 py-2 text-left transition ${activeId === section.id && !query ? "border-white/20 bg-white/10" : "border-transparent text-slate-400 hover:bg-white/[0.06] hover:text-white"}`,
					...
					className: "min-w-0",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "overflow-hidden rounded-lg border border-white/10 bg-white/[0.045] shadow-2xl",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "border-b border-white/10 p-5 sm:p-7",
							style: { background: `linear-gradient(135deg, ${displaySection.color}22, rgba(255,255,255,0.03))` },
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(displaySection.icon, { size: 27 })
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mb-2 text-[10px] font-bold uppercase tracking-[0.24em] text-slate-400",
											children: query ? language === "vi" ? "Tìm kiếm" : "Search" : current.guideLabel
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
											className: "text-2xl font-black tracking-tight text-white sm:text-4xl",
											children: query ? current.searchTitle(query) : displaySection.title
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-2 max-w-2xl text-sm leading-6 text-slate-300",
											children: query ? current.searchSummary(visibleItems.length) : displaySection.summary
										})
									] })]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/studio",
									...
									children: current.openStudio
								})]
							})
						}), visibleItems.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									...
									children: current.emptyTitle
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-2 text-sm text-slate-400",
									children: current.emptyBody
								})
							]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "grid gap-4 p-4 sm:p-6",
							children: visibleItems.map(({ item, section }, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GuideCard, {
								item,
								section,
								index,
								labels: current
							}, `${language}-${section.id}-${item.title}`))
						})]
					})
				})]
			})
...
function GuideCard({ item, section, index, labels }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		className: "rounded-lg border border-white/10 bg-black/25 p-4 transition hover:border-white/20 hover:bg-black/30 sm:p-5",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							...
							children: item.title
						}), item.shortcut && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kbd, { children: item.shortcut })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-1 text-sm leading-6 text-slate-300",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "font-semibold text-slate-100",
							children: [labels.purposeLabel, ": "]
						}), item.purpose]
					})]
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			className: "mt-4 grid gap-4 lg:grid-cols-[1fr_0.75fr]",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mb-2 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Command, { size: 13 }), labels.stepsLabel]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
				className: "space-y-2",
				children: item.steps.map((line, stepIndex) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					className: "flex gap-3 text-sm leading-6 text-slate-300",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded bg-white/10 text-[10px] font-bold text-white",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mb-2 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { size: 13 }), labels.tipsLabel]
				}), item.tips?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					className: "space-y-2",
					children: item.tips.map((tip) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
						className: "text-sm leading-6 text-slate-300",
						children: tip
					}, tip))
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-sm leading-6 text-slate-400",
					children: labels.defaultTip
				})]
			})]
		})]
	});
...
function Kbd({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("kbd", {
		className: "rounded border border-white/15 bg-white/10 px-2 py-0.5 font-mono text-[11px] font-bold text-fuchsia-100",
		children
	});
}
function VnFlag() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
			...
			fill: "#ffcd00",
			points: "450,114.6 548.8,418.7 290.1,230.7 609.9,230.7 351.2,418.7"
		})]
	});
}
function EnFlag() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
			...
			d: "M22,0 h6 v30 h-6 z M0,12 h50 v6 h-50 z",
			fill: "#ce1124"
		})]
	});
}
